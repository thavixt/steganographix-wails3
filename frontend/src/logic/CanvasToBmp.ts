...
export var CanvasToBMP = {
   ...
   * @return {ArrayBuffer}
   */
  toArrayBuffer: function(canvas: HTMLCanvasElement) {
    ...
    function setU16(value: number) {view.setUint16(pos, value, true); pos += 2}
    function setU32(value: number) {view.setUint32(pos, value, true); pos += 4}
  },
   ...
   * @return {Blob}
   */
  toBlob: function(canvas: HTMLCanvasElement) {
   ...
   * @return {string}
   */
  toDataURL: function(canvas: HTMLCanvasElement) {
